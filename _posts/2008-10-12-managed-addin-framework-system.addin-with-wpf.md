...
disqus_identifier: https://www.matthidinger.com/archive/2008/10/12/managed-addin-framework-system.addin-with-wpf.aspx
...
-   [Daniel Roth 18 min screencast](https://channel9.msdn.com/posts/DanielMoth/Managed-AddIn-Framework/)
-   [Excellent MSDN coverage of MAF](https://msdn.microsoft.com/en-us/library/bb384200.aspx "https://msdn.microsoft.com/en-us/library/bb384200.aspx")
...
![](/images/subtext-content/ManagedAddInFrameworkSystem.AddInwithWPF_B14E/image_thumb.png)
...
![](/images/subtext-content/ManagedAddInFrameworkSystem.AddInwithWPF_B14E/image_thumb_3.png)


### Step 1 – Define Contact Interface and utilize Pipeline Builder

The first thing you need to be (painfully) aware of, is the project/directory structure that the MAF Pipeline requires. There is some flexibility here but not a whole lot of wiggle room. Thankfully, the only project I have to concern myself with is the Contract assembly (CouchPotato.AddIn.Contract below). With a proper directory structure in place you can use a tool that the MAF team released called [Pipeline Builder](https://www.codeplex.com/clraddins/Release/ProjectReleases.aspx?ReleaseId=9222) to generate the necessary MAF projects for you automatically. The arrows below indicate which projects were generated by Pipeline Builder – **it is important to understand that the only project/code I actually wrote in this entire solution is the ICouchPotatoAddInContract.cs.** Please see the screencast above or the resources below for more details on Pipeline Builder.

![](/images/subtext-content/ManagedAddInFrameworkSystem.AddInwithWPF_B14E/image_thumb_4.png)
...
-   Next, I chose to specify some naming ‘hints’ to the Pipeline builder. These hints tell the Pipeline Builder utility what to name the 4 assemblies that it will be generating for me. Click here to view [all available Pipeline Hints](https://www.codeplex.com/clraddins/Wiki/View.aspx?title=Using%20PipelineHints%20to%20Customize%20Output&referringTitle=Pipeline%20Builder)
...
-   We are almost done, but before we build this project we need to change to output path from the default “/bin/Debug” to “../output/Contracts”. For further explanation on this please see the [excellent screencast by Daniel Moth](https://channel9.msdn.com/posts/DanielMoth/Managed-AddIn-Framework/).

![](/images/subtext-content/ManagedAddInFrameworkSystem.AddInwithWPF_B14E/image_thumb_5.png)
...
![](/images/subtext-content/ManagedAddInFrameworkSystem.AddInwithWPF_B14E/image_thumb_6.png)
...
![](/images/subtext-content/ManagedAddInFrameworkSystem.AddInwithWPF_B14E/image_thumb_7.png)


-   Finally, change your build output path to the root output directory

![](/images/subtext-content/ManagedAddInFrameworkSystem.AddInwithWPF_B14E/image_thumb_8.png)
...
![](/images/subtext-content/ManagedAddInFrameworkSystem.AddInwithWPF_B14E/image_thumb_9.png)
...
![](/images/subtext-content/ManagedAddInFrameworkSystem.AddInwithWPF_B14E/image_thumb_10.png)
...
-   [](https://11011.net/software/vspaste)Lastly, create a the WeatherAddIn.cs file
...
![](/images/subtext-content/ManagedAddInFrameworkSystem.AddInwithWPF_B14E/image_thumb_11.png)
...
-   [Excellent Daniel Moth screencast on MAF](https://channel9.msdn.com/posts/DanielMoth/Managed-AddIn-Framework/ "https://channel9.msdn.com/posts/DanielMoth/Managed-AddIn-Framework/")
-   [Managed AddIn Framework at CodePlex](https://www.codeplex.com/clraddins "https://www.codeplex.com/clraddins")
-   [Pipline Builder](https://www.codeplex.com/clraddins/Release/ProjectReleases.aspx?ReleaseId=9222 "https://www.codeplex.com/clraddins/Release/ProjectReleases.aspx?ReleaseId=9222")
